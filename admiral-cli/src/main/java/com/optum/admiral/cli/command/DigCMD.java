...
public class DigCMD extends AbstractAdmiralCommand {

    public DigCMD() {
        super("dig", "Dig up parameter values listed in x-admiral_dig");
    }
    ...
    public void executeCommand(UXPreferences uxPreferences, Admiral admiral, OutputWriter outputWriter, List<String> args)
        ...
        admiral.digACT(uxPreferences.outputPreferences, uxPreferences.outputStyler, outputWriter, args, false);
    }
