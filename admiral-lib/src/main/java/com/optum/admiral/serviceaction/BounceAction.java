...
public class BounceAction extends ServiceAction {

    public BounceAction(Admiral admiral, DockerModelController dmc, ComposeConfig composeConfig) {
